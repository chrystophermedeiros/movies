    ...
    if (moreMovies) {
      for (let i = 0; i < moreMovies.length; i++) {
        if (
          ...
          moreMovies[i].title.toLowerCase()
        ) {
      ...
      {movie && (
        ...
        >
          <HelpBox>
            ...
            />
            <ButtonSearch onClick={Seek}>Buscar</ButtonSearch>
          </HelpBox>
          {showModal && (
          ...
          <Container>
            <Info>
              ...
              <ContainerButtons>
                <Button
                  red={true}
                  onClick={() => navigate(`/detalhefilmes/${movie.id}`)}
                >
                  Assista agora
                </Button>
